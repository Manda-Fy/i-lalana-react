        ...
        <main id="main-home" className="min-h-screen bg-gradient-to-t from-olive-100 via-stone-50 to-white text-slate-900 font-lato">
          <section id="hero-section" className="max-w-6xl mx-auto px-5 py-16 md:py-20">
            <div id="hero-grid" className="grid gap-10 md:grid-cols-2 items-center">
              <div id="hero-text">
                ...
                <div id="hero-statistics" className="flex flex-wrap gap-4">
                  <button onClick={() => navigate('/explore')} id="stat-laws" className="px-4 py-2 rounded-xl bg-amber-900 text-white font-bold hover:shadow-lg hover:scale-105 transition-all duration-300">Zahao ireo lalàna </button>
                </div>
              </div>
            ...
            <div id="summary-cards" className="mt-14 grid gap-6 md:grid-cols-3">
              <article onClick={() => navigate('/explore')} id="card-types" className="p-5 bg-white rounded-xl shadow-sm border hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <article onClick={() => navigate('/explore')} id="card-procedure" className="p-5 bg-white rounded-xl shadow-sm border hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <article onClick={() => navigate('/explore')} id="card-gravity" className="p-5 bg-white rounded-xl shadow-sm border hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
